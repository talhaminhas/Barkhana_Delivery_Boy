...
import 'package:flutterrtdeliveryboyapp/ui/common/dialog/share_app_dialog.dart';
...
class CoreDrawerDashboardView extends StatefulWidget {
  const CoreDrawerDashboardView(
      ...
      required this.mainDashboardProvider,
  ...
  final MainDashboardProvider? mainDashboardProvider;
          ...
          builder: (BuildContext context, UserProvider provider, Widget ?child) {
            ...
            return ListView(padding: EdgeInsets.zero, children: <Widget>[
              ...
              /*ListTile(
                ...
                title: Text(
                  Utils.getString(context, 'home__menu_drawer_share_this_app'),
                  style: Theme.of(context).textTheme.bodyLarge,
                ),
                onTap: () {
                  Navigator.pop(context);
              ...
              /*ListTile(
                ...
                title: Text(
                  Utils.getString(context, 'home__menu_drawer_rate_this_app'),
                  style: Theme.of(context).textTheme.bodyLarge,
                ),
                onTap: () {
                  Navigator.pop(context);
...
class _DrawerHeaderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DrawerHeader(
      ...
      decoration: BoxDecoration(color: PsColors.mainLightColor),
    );
  }
}
